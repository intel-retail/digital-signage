...
services (MediaMTX, Mosquitto, Milvus, etcd, COTURN) that communicate via MQTT and REST APIs.
...
2. If a predefined ad is found in Milvus, it is displayed immediately.
