...
Predefined advertisements are static JPEG/JPG images that the ASe service stores in ChromaDB and returns when a matching product is detected. This guide explains how to provision products with predefined ads.

## Prerequisites

- Ensure the application is deployed. See [Deploy with Docker Compose](../get-started/deploy-with-docker-compose.md).
